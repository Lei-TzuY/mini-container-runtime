...
// normalizeContainerPath resolves requested using container-root semantics.
// Parent traversals are clamped at "/" instead of being applied to the host
// output directory.
...
// resolveRootFSPath follows symlinks using container-root semantics. Absolute
// symlink targets are resolved relative to root, not to the host's "/".
